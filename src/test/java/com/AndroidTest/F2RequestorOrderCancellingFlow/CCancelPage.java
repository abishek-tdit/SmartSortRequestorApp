...
//=========================================================
    ...
    public void openOrders() {
        ...
        WebElement orders = wait.until(
                ExpectedConditions.elementToBeClickable(ordersButton));
    ...
    public void selectOrderToCancel(String orderNumberCancel ) throws InterruptedException {
