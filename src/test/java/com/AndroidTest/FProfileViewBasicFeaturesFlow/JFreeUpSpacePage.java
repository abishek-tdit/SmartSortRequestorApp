...
public class JFreeUpSpacePage {

    AndroidDriver driver;
    WebDriverWait wait;

    public JFreeUpSpacePage(AndroidDriver driver) {
        this.driver = driver;
    ...
    public void scrollAndOptimize() throws InterruptedException {
        ...
        freeUpBtn.click();
        System.out.println("Free up space Clicked");
    ...
    try {
       ...
       // BACK NAVIGATION
        ...
        try {
            ...
            System.out.println("⚠️ First back button not found, using driver.navigate().back()");
        ...
        try {
            ...
            System.out.println("⚠️ Second back button not found, using driver.navigate().back()");
            driver.navigate().back();  // fallback
        }
