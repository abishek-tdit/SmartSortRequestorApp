...
public class CBusinessPointHistoryPage extends BasePage {

    public CBusinessPointHistoryPage(AndroidDriver driver) {
        super(driver);
    }
    ...
    private final By startDate =
            AppiumBy.accessibilityId("2026-07-05");
    ...
    private final By endDate =
            AppiumBy.accessibilityId("2026-08-04");

    private final By endDay =
            AppiumBy.accessibilityId("4, Tuesday, August 4, 2026, Today");
