...
//
        ...
        if (matcher.find()) {
            ...
            OrderData.orderNumber = matcher.group();

            System.out.println("Saved Order Number : " + OrderData.orderNumber);

            ExtentTestListener.logStep("Order Number Saved : " + OrderData.orderNumber);
        ...
        ExtentTestListener.getTest().pass(
                "Door Pickup Flow Completed Successfully. Order Number: " + OrderData.orderNumber);
