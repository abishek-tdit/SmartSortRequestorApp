...
public class CRaiseTicketPage {
    ...
    public void raiseTicket() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                AppiumBy.accessibilityId("Raise Ticket"))).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                AppiumBy.accessibilityId("Select subject line"))).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                AppiumBy.accessibilityId("Order Related"))).click();
        ...
        // Click Submit Ticket
        wait.until(ExpectedConditions.elementToBeClickable(
                AppiumBy.accessibilityId("Submit Ticket"))).click();
